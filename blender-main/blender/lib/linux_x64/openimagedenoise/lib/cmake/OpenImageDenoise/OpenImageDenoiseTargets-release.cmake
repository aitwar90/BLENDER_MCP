...
set_target_properties(OpenImageDenoise_core PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenImageDenoise_core.so.2.5.0"
  IMPORTED_SONAME_RELEASE "libOpenImageDenoise_core.so.2.5.0"
  )

list(APPEND _cmake_import_check_targets OpenImageDenoise_core )
list(APPEND _cmake_import_check_files_for_OpenImageDenoise_core "${_IMPORT_PREFIX}/lib/libOpenImageDenoise_core.so.2.5.0" )
...
set_target_properties(OpenImageDenoise PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenImageDenoise.so.2.5.0"
  IMPORTED_SONAME_RELEASE "libOpenImageDenoise.so.2"
  )

list(APPEND _cmake_import_check_targets OpenImageDenoise )
list(APPEND _cmake_import_check_files_for_OpenImageDenoise "${_IMPORT_PREFIX}/lib/libOpenImageDenoise.so.2.5.0" )
